...
//		System.out.println("ty le thay doi ban ma: " + a);
	...
	static float CompareBitTag(String Str1, String Str2, String text) {
		float Count = 0, a = 0;
		int Taglen = 0; // the tag CCM = 8 byte = 16hex =64bit
...
//			System.out.println("1_add A+U: " + (nano_endTimeAdd - nano_startTimeAdd));
			System.out.println((nano_endTimeAdd - nano_startTimeAdd));
			if (i != 0) {
		...
		System.out.println("medium time muilti: " + totalMulti / (n - 1));
		System.out.println("medium time add: " + totalAdd / (n - 1));
...
////		byte[] cleartext = hexStringToByteArray(cleartext1);
...
//			int len = ccm.processBytes(cleartext, 0, cleartext.length, ciphertext, 0);// the number of bytes written to
//																						// out.
//			try {
...
//				System.out.println((nano_endTime2 - nano_startTime2));
//
////			System.out.println("Total time taken in nano seconds SHA: "+(nano_endTimeSHA-nano_startTimeSHA));
//				System.out.println((nano_endTimeSHA - nano_startTimeSHA));
//			}
//
//			// System.out.println("cleartext: " + toHex(decode));
//		}
//		System.out.println("\nCCM medium time encrypt: " + total / (n -1));
//		System.out.println("CCM medium time decrypt: " + total1 / (n -1));
//		System.out.println("medium time SHA: " + totalSHA / (n -1));
//
//	}
...
////			int len = ccm.processBytes(hexStringToByteArray(cleartext), 0, hexStringToByteArray(cleartext).length,
////					encryptedText, 0);// the number of bytes written to out.
////			try {
...
////			
////			//compare tag
////			total += CompareBitTag(toHex(encryptedText), hex, "hex");
