...
public class EncryptorAesGcm {
    ...
    public static byte[] encrypt(byte[] pText, SecretKey secret, byte[] iv) throws Exception {
        ...
        System.out.println("----------------------------------------------\n Time getInstance Ciphertext: "
                + (System.nanoTime() - nano_startTime));
        
        nano_startTime = System.nanoTime();
        cipher.init(Cipher.ENCRYPT_MODE, secret, new GCMParameterSpec(TAG_LENGTH_BIT, iv));
        System.out.println("Time initialize Ciphertext: "
                + (System.nanoTime() - nano_startTime));
        
        nano_startTime = System.nanoTime();
        byte[] encryptedText = cipher.doFinal(pText);
        System.out.println("Time doFinal Ciphertext: "
                + (System.nanoTime() - nano_startTime));
    ...
    public static byte[] encryptWithPrefixIV(byte[] pText, SecretKey secret, byte[] iv) throws Exception {
        ...
        //System.out.println("Time encrypt ciphertext: "
               // + (System.nanoTime() - nano_startTime));
        ...
        byte[] cipherTextWithIv = ByteBuffer.allocate(iv.length + cipherText.length)
                ...
                .put(cipherText)
                .array();
        System.out.println("Time allocate Buffer Ciphertext + iv: "
                + (System.nanoTime() - nano_startTime));
    ...
    public static void main(String[] args) throws Exception {
		...
		System.out.println("length pText.getBytes(UTF_8): "+pText.getBytes(UTF_8).length);
