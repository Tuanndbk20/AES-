    ...
    implements SkippingStreamCipher
{
    ...
    {
    	System.out.println("process in SICBlockCipher(counterMode)!");
          ...
          throws DataLengthException, IllegalStateException
    {
        if (byteCount == 0)
        {
        	System.out.println("ctr: "+toHex(counter));
            cipher.processBlock(counter, 0, counterOut, 0);// encrypt Ctr and key
            System.out.println("Sj: "+toHex(counterOut));
