    ...
    implements AEADBlockCipher
{
    ...
    {
    	System.out.println("initialize GCMBlockCipher!");
    ...
    {
    	System.out.println("save parameter Key, MacBitSize(128bit), iv, associatedText(null)!");
        ...
        if (keyParam != null)
        {
            ...
            System.out.println("created H: "+toHex(H));
        ...
        if (nonce.length == 12)
        {
        	System.out.println("if nonce=12 then J0 = IV || 0^31 || 1");
        ...
        throws DataLengthException
    {
        ...
        if (forEncryption)
        {
            ...
            System.out.println("encryptedBytes after processBlock -- gHASHBlock: "+toHex(out));
        ...
        throws IllegalStateException, InvalidCipherTextException
    {
        ...
        if (extra > 0)
        {
            processPartial(bufBlock, 0, extra, out, outOff); // xu li plaintext con du
        }
        ...
        if (atLength > atLengthPre)
        {
            ...
            GCMUtil.xor(S, S_at);
            System.out.println("S(Adjust the current hash): "+S);
        }
        ...
        gHASHBlock(S, X);
        System.out.println("S(Final gHASH): "+toHex(S));
        ...
        System.out.println("tag(T): "+toHex(tag));
        ...
        if (forEncryption)
        {
            ...
            System.out.println("bufOff: "+(outOff + bufOff));
            resultLen += macSize;
        }
        else
        {
    ...
    private void processBlock(byte[] buf, int bufOff, byte[] out, int outOff)
    {
        ...
        if (forEncryption)
        {
            GCMUtil.xor(ctrBlock, buf, bufOff); //C = GCTRK(inc32(J0), P)
            System.out.println("C: "+toHex(ctrBlock));
            System.out.println("before S: "+toHex(S));
            gHASHBlock(S, ctrBlock); // ghash H vs C
            System.out.println("after GHASH S: "+toHex(S));
    ...
    private void getNextCTRBlock(byte[] block)
    {
        ...
        System.out.println("Counter clone(J0) "+toHex(counter));
        ...
        System.out.println("after Counter clone(J0) "+toHex(counter));
        
        cipher.processBlock(counter, 0, block, 0); // CIPHk
    }
